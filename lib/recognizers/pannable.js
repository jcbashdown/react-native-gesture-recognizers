...
var propTypes = {
  onPanBegin: _reactNative.PropTypes.func,
  onPan: _reactNative.PropTypes.func,
  onPanEnd: _reactNative.PropTypes.func,
  resetPan: _reactNative.PropTypes.bool,
  panDecoratorStyle: _reactNative.PropTypes.object
};
      ...
      _createClass(_class, [{
        ...
        value: function render() {
          ...
          return _reactNative2['default'].createElement(
            ...
            _reactNative2['default'].createElement(BaseComponent, _extends({}, props, this.state))
          );
        }
      }], [{
        key: 'propTypes',
